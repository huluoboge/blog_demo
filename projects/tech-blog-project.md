...
excerpt: "一个基于Node.js的静态博客生成器，支持Markdown、LaTeX数学公式和Mermaid流程图。"
---

# 技术博客项目

这是一个使用Node.js开发的静态博客生成器，专门为技术人员设计，支持丰富的文档特性。
...
如果您遇到任何问题或有建议，请创建 [Issue](https://github.com/yourusername/tech-blog/issues)。

---

这是一个持续开发的项目，欢迎提出建议和贡献代码！
